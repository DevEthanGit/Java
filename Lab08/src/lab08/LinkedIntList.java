...
public class LinkedIntList {
	...
	// links of the list.
	public void shift(){ //every node at ann odd index and push them to the back 1 3 5 8 2 -> 1 5 2 3 8 odd index
		if (front == null) {return;}
	        ListNode list, even, odd;
	        list = even = odd = front;
	        list = front.next;
	...
	// if the list is empty simply return [1][2][3][null] -> [1][1][2][2][3][3] [null] //one constructior will be helpful
	public void stutter(){
		ListNode current = front;
